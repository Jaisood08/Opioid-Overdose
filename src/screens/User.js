...
const Alertod = ({signOut,userState, authState, navigation}) => {
    ...
    return (
      ...
      >
        ...
        <View style={{width:'60%'}}>
          <Text style={styles.text2}>{userState.bio}</Text>
        </View>
        </View>
        ...
        <View style={{width:'60%'}}>
        <Text style={styles.text2}>{userState.country}</Text>
        </View>
        </View>
        ...
        <View style={{width:'60%'}}>
        <Text style={styles.text2}>{userState.Contact}</Text>
        </View>
        </View>
        ...
        <View style={{width:'60%'}}>
        <Text style={styles.text2}>{userState.email}</Text>
        </View>
        </View>
        ...
        <View style={{width:'60%'}}>
        <Text style={styles.text2}>{userState.Address}</Text>
        </View>
        </View>
        </>
        )}
